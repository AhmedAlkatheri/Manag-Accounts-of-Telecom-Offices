...
namespace Test_1.Business_Layer
{
    class Accounts
    {
        ...
        public DataTable GET_Account_Table(int ID_system)
        {
            Data_Access_Layer.DAL dal = new Data_Access_Layer.DAL();
            SqlParameter[] param = new SqlParameter[1];
        ...
        public void ADD_Account_Table(DateTime date, string time, string proces, string move, int REC_tx, int EXH_tx, string text, 
            int ID_client, int ID_user, int ID_telecom, int ID_system , String TYPE_Account)
        {
            Data_Access_Layer.DAL dal = new Data_Access_Layer.DAL();
            dal.open();
            ...
            param[9] = new SqlParameter("@ID_telecom", SqlDbType.Int);
        ...
        public void ADD_NEW_debt_Table(DateTime date, string time, string move, int FOR, int ON, int BALANCE_debt, int ID_client, int ID_user)
        {
            Data_Access_Layer.DAL dal = new Data_Access_Layer.DAL();
            dal.open();
            ...
            param[2] = new SqlParameter("@MOVE_debt", SqlDbType.VarChar, 10);
            param[2].Value = move;

            param[3] = new SqlParameter("@FOR_debt", SqlDbType.Int);
            param[3].Value = FOR;

            param[4] = new SqlParameter("@ON_debt", SqlDbType.Int);
            param[4].Value = ON;

            param[5] = new SqlParameter("@BALANCE_debt", SqlDbType.Int);
            param[5].Value = BALANCE_debt;
        ...
        public void ADD_debt_Table_and_ID_Account(DateTime date, string time, string PROCESS, string move, int FOR, int ON, int BALANCE_debt, string TEXT, int ID_client, int ID_user, string TYPE_debt, int ID_system, int ID_Account)
        {
            Data_Access_Layer.DAL dal = new Data_Access_Layer.DAL();
            dal.open();
        ...
        public void EDIT_debt_Table_and_ID_Account(string PROCESS, string move, int FOR, int ON, int BALANCE_debt, string TEXT, int ID_client, string TYPE_debt, int ID_system, int ID_Account)
        {
            Data_Access_Layer.DAL dal = new Data_Access_Layer.DAL();
            dal.open();
            ...
            param[8] = new SqlParameter("@ID_system", SqlDbType.Int);
        ...
        public DataTable SUM_REC_Account(int ID_system)
        {
            Data_Access_Layer.DAL dal = new Data_Access_Layer.DAL();
            SqlParameter[] param = new SqlParameter[1];
        ...
        public DataTable SUM_no_debe(int ID_system)
        {
            Data_Access_Layer.DAL dal = new Data_Access_Layer.DAL();
            SqlParameter[] param = new SqlParameter[1];
        ...
        public DataTable SUM_EXH_Account(int ID_system)
        {
            Data_Access_Layer.DAL dal = new Data_Access_Layer.DAL();
            SqlParameter[] param = new SqlParameter[1];
        ...
        public void EDIT_Account_Table( int ID_Account, string PROCESS_Account, string MOVE_Account, int REC_Account, int EXH_Account, string TEXT_Account,
                                        int ID_client, int ID_telecom, int ID_system, String TYPE_Account )
        {
            Data_Access_Layer.DAL dal = new Data_Access_Layer.DAL();
            dal.open();
        ...
        public void ADD_NEW_user_Table(string USERNAME, string PASSWORD, string FULLNAME, int MOBILE)
        {
            Data_Access_Layer.DAL dal = new Data_Access_Layer.DAL();
            dal.open();
        ...
        public void EDIT_user_Table(int ID_user, string USERNAME, string PASSWORD, string FULLNAME, int MOBILE)
        {
            Data_Access_Layer.DAL dal = new Data_Access_Layer.DAL();
            dal.open();
